...
const schema = yup.object({
  ...
  telefono: yup
    ...
    .matches(/^\+[1-9]\d{10,14}$/, "Ingrese un telefono valido"),
  mensaje: yup
    .string()
    .required("El mensaje es requerido")
    .min(10, "Por favor que su mensaje sea detallado"),
});
        ...
        >
          ...
          <div className="relative flex flex-col lg:flex-row justify-between items-center">
            ...
            <div className="w-full mt-16 md:mt-0 md:w-2/5">
              <div className="z-10 h-auto p-8 py-10 overflow-hidden border-b-2 border-gray-300 rounded-lg shadow-2xl px-7">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  <input
                    type="email"
                    placeholder="Correo de trabajo o personal"
                    className="block w-full px-4 py-3 mb-4 border-2 border-transparent border-gray-200 rounded-lg text-black"
                    {...register("email")}
                  />
                  <input
                    type="text"
                  ...
                  ></textarea>
                  <button
                    className="w-full px-3 py-4 font-medium text-white bg-transparent hover:bg-sky-400 border border-slate-300 text-sky-400 hover:text-sky-50 rounded-full"
                    type="submit"
                  >
                    Send
                  </button>
