      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Servicios de instalación de antenas de telecomunicaciones.</h2>
            <p className="text-xl text-gray-400">Somos una empresa joven motivados por realizar un servicio confiable, rápido de bajos costos.</p>
          </div>
